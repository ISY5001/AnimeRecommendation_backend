...
if __name__ == '__main__':
    movies_feature = pd.read_csv(
        '/home/hewen/ISS-workshop/MVP/IRS-MyAnime/python_backend/data/movies_feature.csv',
        index_col=0)
    user_rating = pd.read_csv(
        '/home/hewen/ISS-workshop/MVP/IRS-MyAnime/python_backend/data/user-rating.csv', index_col=0)
